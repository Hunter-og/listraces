...
export default function Footer2() {
    ...
    return (
        <div className='flex flex-col md:flex-row justify-between items-center py-4 px-6 bg-gray-100'>
            ...
            <div className='flex flex-col md:flex-row gap-4 items-center'>
                ...
                <div className='flex gap-3'>
                    {lists.map((eachlist, index) => (
                        <div key={index} className='bg-[#00000062] rounded-full p-2 hover:bg-black transition'>
                            {eachlist.icon}
                        </div>
                    ))}
                </div>
